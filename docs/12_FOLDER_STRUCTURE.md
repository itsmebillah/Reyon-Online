...
Architecture documents now include numbered domain foundations through `19_OPERATING_TOPOLOGY_ARCHITECTURE.md`. New numbered documents must be added to the README documentation map and related-document links.
