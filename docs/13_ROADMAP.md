...
| 21     | Accounts and Payments                | Sales, refunds, purchasing, accounting and payment foundations                                     | In progress: controlled configuration, immutable Completed-sale revenue/COGS, weighted-average valuation, and accepted-receipt supplier payable/purchase-return credit accounting released. Supplier payment accounting, refunds, expenses, reconciliation and close remain later milestones. See [Sprint 21](33_ACCOUNTS_PAYMENTS_DECISION_PACKET.md). |
