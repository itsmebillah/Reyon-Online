...
| 21     | Accounts and Payments                | Sales, refunds, purchasing, accounting and payment foundations                                     | Approved for sequential implementation; accounting-configuration foundation in progress. Production posting remains gated by configurable legal/fiscal details, real financial accounts/opening evidence, and Finance approver assignment. See [Sprint 21](33_ACCOUNTS_PAYMENTS_DECISION_PACKET.md). |
