...
| 21     | Accounts and Payments                | Sales, refunds, purchasing, accounting and payment foundations                                     | In progress: controlled configuration and immutable double-entry foundation released and hardened for deterministic Finance-approved account selection; Completed sale is the only automatic posting. COGS, payables, refunds, expenses, reconciliation and close remain later milestones. See [Sprint 21](33_ACCOUNTS_PAYMENTS_DECISION_PACKET.md). |
