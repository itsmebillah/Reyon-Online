...
import { completePosSale } from "@/features/pos/actions";
...
import type { PosContext, PosProduct, PosReceipt } from "@/features/pos/types";
  ...
  return (
    <div className="pos-page">
      <header className="pos-page-header">
        ...
        <span className="pos-badge">Ready · {register.name}</span>
      </header>
